...
export default function HomeClient({ seoContent }: { seoContent?: React.ReactNode }) {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F5F5F5" }}>
      ...
      <div style={{ backgroundColor: "white", marginTop: "8px", borderTop: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}` }}>
        <div className="px-4 md:px-6 py-5">
          <div className="flex items-center justify-between mb-4">
            <h2 style={{ fontSize: "15px", fontWeight: 700, color: TEXT }}>Browse Wholesale Categories</h2>
      ...
      {/* Server-rendered SEO content (passed from the server page) */}
      {seoContent}
